...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the accounting-bank-accounts public boundary. I
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-accounting-bank-accounts-filament?sort=semver)](https://github.com/liberusoftware/module-accounting-bank-accounts-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-accounting-bank-accounts-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-accounting-bank-accounts-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-accounting-bank-accounts-filament
```
...
<a href="https://github.com/liberusoftware/module-accounting-bank-accounts-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-accounting-bank-accounts-filament" alt="Contributors to liberusoftware/module-accounting-bank-accounts-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-accounting-bank-accounts-filament/graphs/contributors).
